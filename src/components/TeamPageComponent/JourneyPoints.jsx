        ...
        <div className='row container'>
          <div className='col-12 col-md-6'>
            {data.map((item, index) => (
              <div
                key={index}
                className='Dots_contants box d-flex align-items-start justify-content-center gap-4 aos-init'
                data-aos='fade-down'
          ...
          <div className='col-12 col-md-6'>
            {data2.map((item, index) => (
              <div
                key={index}
                className='Dots_contant box d-flex align-items-start gap-4 aos-init'
                data-aos='fade-up'
                data-aos-easing='linear'
                data-aos-duration={index * 500 + 10}
              >
                <div className={`cyrcle ${index === data2.length - 1 ? 'last-item' : ''}`}></div>
                <small>{item.small}</small>
              ...
              <div className='box'>
                <div className='detals d-flex flex-column justify-content-center align-items-center'>
                  <div className='d-flex gap-5'>
                    ...
                    />
                    <h3 ref={(el) => (countersRef.current[index] = el)} className='counter' data-target={item.target}>
                      0
                    </h3>
                  </div>
