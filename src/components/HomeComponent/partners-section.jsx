  ...
  return (
    <div className='Your_partner_in_success position-relative'>
      <div className='container'>
        <div className='title m-5 d-flex justify-content-between align-items-center' data-aos='zoom-in' suppressHydrationWarning>
          <h3>
            شريكك في <span>النجاح الرقمي</span>
          </h3>
        </div>

        <div className='partnersLogos' data-aos='fade-up' suppressHydrationWarning>
