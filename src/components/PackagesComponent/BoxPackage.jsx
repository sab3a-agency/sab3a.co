  ...
  return (
    <section className='boxPackages mt-5 '>
      <div className='container'>
        <div className='WrapperBoxOuter d-flex-column  d-md-flex d-xl-flex justify-content-center align-items-start gap-5'>
            ...
            return (
              ...
              >
                <div className='container'>
                  ...
                  <div className='box-innerfeatures'>
                    {outeritem.subTitle.map((item, index) => {
                      return (
                        <div key={index} className='innerfeatures d-flex justify-content-center align-items-center gap-3 my-3'>
                          <Image loading='lazy' src={outeritem.Innericon} width={20} height={20} alt='check' />
                ...
                <div className='Wrapper '>
                  <Link href='/contact-us' className='d-flex justify-content-center'>
